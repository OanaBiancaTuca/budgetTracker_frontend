...
import { createAccount, sendVerificationCode, verifyCode, setOtpError, setDisplayUserDetailsForm, setDisplayOtpForm, setDisplayPasswordForm } from "../features/userSlice";
...
export default function SignupForm(props) {
    ...
    useEffect(() => {
        if (otpError) {
            setTimeout(() => {
                ...
                otpForm.reset();
                dispatch(setDisplayUserDetailsForm(true));
                dispatch(setDisplayOtpForm(false));
                dispatch(setDisplayPasswordForm(false));
            }, 5000); // Reset OTP form and go back to user details form after 5 seconds
        }
    }, [otpError, dispatch, otpForm]);
    ...
    function handleSendVerificationCode() {
        ...
        dispatch(setDisplayUserDetailsForm(false));
        dispatch(setDisplayOtpForm(true));
    }
